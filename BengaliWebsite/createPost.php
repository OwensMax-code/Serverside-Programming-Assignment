...
{
	header('Location: BengaliLogin.php?msg=notLoggedIn');
}
...
<main>
<h1 class='display-5 text-center mt-3 mb-3'>Create Post</h1>
...
?>
<form class="mt-3 p-3 w-50 border border-dark" action="createPost.php" method="POST" style="margin:0 auto;background-color:#FF7F50;">
