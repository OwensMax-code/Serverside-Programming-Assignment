...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST')
{
	...
	if (verifyInformation($db, $userName, $email))
	{
		...
		header('Location:BengaliLogin.php?msg=passwordSuccess');
	}
	else
	{
		header('Location:BengaliForgotPassword.php?msg=badTry');
	}
}
?>
<head>
			...
			<div class='d-flex flex-row'>
				...
				<a class="navbar-brand" href="#">
					<img src="img/language.png" width="80" height="30" class="d-inline-block align-top" alt="">
							...
							<main>
								<div>
									<h1 class="display-2 text-center mt-3 mb-3">Forgot Password Form</h1>
									<h5 class="text-center mt-3 mb-3">Enter the details of the account to confirm it's you and not a naughty thief.</h5>
									<?php
