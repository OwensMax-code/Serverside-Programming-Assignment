...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST')
{
	...
	{
		header('Location:sudokuForgotPassword.php?msg=badTry');
	}
}
?>
<HTML>
<head>
	...
	<title>
		<?=I18n::checkText( "Forgot Password")?>
	</title>
</head>
			...
			<div>
				<?php if ( isset ($_SESSION[ 'theAccountID']))
						...
						{ 
							...
							<main>
								<div>
									<h1 class="display-2 text-center text-danger mt-3 mb-3">Forgot Password Form</h1>
									<h5 class="text-center text-danger mt-3 mb-3">Enter the details of the account to confirm it's you and not a naughty thief.</h5>
									<?php
									if (isset($_GET["msg"]) && $_GET["msg"] == 'badTry')
									{
										echo '<h3 class="text-center text-danger">Incorrect username/email combination.</h3>';
									}
									echo getForgotPasswordForm();
									?>
											</div>
										</main>
									</body>
